...
public class ManagerServiceImpl implements iManager {
    @Override
    public void hireCashier(String ApplicantName, int ApplicantAge , String ApplicantReply,  Cashier cashier) {
...
//        int ApplicantAge = input.nextInt();
        ...
        if (ApplicantAge >= 21 ){
          ...
          //  String ApplicantReply = input.next();
            ...
            if(ApplicantReply.equalsIgnoreCase("Yes")){
            ...
            }else if(ApplicantReply.equalsIgnoreCase("No")){
                System.out.println("Sorry, You need To Accept The Terms And Conditions to Get Hired :( ");
            }else {
